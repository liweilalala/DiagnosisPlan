...
params = {}
params['path'] = '/Users/max/Desktop/BearingData/paderborn-train/traindata_N15_M01_F10.csv'
params['opath'] = '/Users/max/Desktop/BearingData/feature/traindata_N15_M01_F10_fea.csv'
...
try:
    ...
    columns_list_all = ['time_mean','time_median', \
                        'freq_mean','freq_std','freq_median', \
                        'freq_f2','freq_f5','freq_f6','freq_f7','freq_f8', \
                        'ener_cD1','ratio_cD1']
    ...
    def feature_get(filepath):
        ...
        for i in range(data.shape[0]):
            ...
            feature_list[i]=[time_mean,time_median, \
                        freq_mean,freq_std,freq_median, \
                        freq_f2,freq_f5,freq_f6,freq_f7,freq_f8, \
                        ener_cD1,ratio_cD1,int(k)]
